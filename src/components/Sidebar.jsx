...
const Sidebar = ({
  ...
  return (
    <div className="w-80 bg-white border-r-2 border-gray-200 p-6 flex flex-col gap-7 h-screen overflow-y-auto scrollbar-thin sticky top-0">
      {/* Title */}
      <h2 className="text-base font-bold text-gray-500 uppercase tracking-wide">
        Filters
      </h2>
      ...
      <div className="flex gap-2">
        {QUICK_FILTERS.map(filter => (
          <div
            key={filter.name}
            className="flex items-center gap-2 px-3.5 py-2 bg-gray-100 border border-gray-200 rounded-lg text-xs font-semibold text-gray-700 cursor-pointer hover:bg-gray-200 transition-colors"
          >
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center justify-between">
          <span className="text-sm font-semibold text-gray-700">Cloud Provider</span>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="px-4 py-6 bg-gray-50 border border-gray-200 rounded-lg flex items-center gap-4">
          <div className="text-gray-500">●</div>
          <div className="flex-1 h-1.5 bg-gradient-to-r from-primary-500 to-gray-300 rounded-full relative">
            <div className="absolute w-4.5 h-4.5 bg-primary-500 border-3 border-white rounded-full left-1/5 top-1/2 -translate-y-1/2 shadow-md cursor-pointer"></div>
          </div>
          <div className="text-gray-500">●</div>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-2">
          {SEVERITIES.map((sev, idx) => (
            ...
            >
              ...
              {idx === 0 && (
                <span className="ml-auto px-2.5 py-1 bg-red-100 text-red-600 rounded text-xs font-bold">
                  A
                </span>
              )}
            </div>
